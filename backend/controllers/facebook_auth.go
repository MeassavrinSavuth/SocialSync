...
// 		if err != nil {
// 			http.Error(w, "Facebook account not connected", http.StatusBadRequest)
// 			return
// 		}

// 		resp, err := http.Get(fmt.Sprintf(
// 			"https://graph.facebook.com/v18.0/%s?fields=instagram_business_account&access_token=%s",
// 			pageID, fbAccessToken,
// 		))
// 		if err != nil {
// 			http.Error(w, "Failed to fetch Instagram account", http.StatusInternalServerError)
// 			return
// 		}
...
// 			http.Error(w, "Failed to decode Instagram data", http.StatusInternalServerError)
// 			return
// 		}
// 		if igData.InstagramBusinessAccount.ID == "" {
// 			http.Error(w, "No IG account connected to the Page", http.StatusBadRequest)
// 			return
// 		}

// 		// Save instagram_account_id
// 		_, err = db.Exec(`
// 			UPDATE social_accounts
// 			SET instagram_account_id = $1
// 			WHERE user_id = $2 AND platform = 'facebook'
// 		`, igData.InstagramBusinessAccount.ID, userID)
// 		if err != nil {
...
// 		w.Write([]byte(`{"message":"Instagram account connected successfully"}`))
// 	}
// }
